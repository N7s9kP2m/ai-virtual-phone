export type Character = {
  ...
  persona: string;       // 人设
  /** Original imported card, including greetings and examples, retained for export. */
  importedCard?: Record<string, unknown>;
  /** One-time repair marker for cards imported before lore profile extraction. */
